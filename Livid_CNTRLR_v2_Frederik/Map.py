...
class CntrlrColors:
	...
	class Session:
		...
		GroupA_Stopped = LividRGB.RED
		GroupB_Stopped = LividRGB.MAGENTA
		GroupC_Stopped = LividRGB.CYAN
	...
	class Translation:
		SelectorOn = LividRGB.OFF
		SelectorOff = LividRGB.OFF

		class Channel_15:
			Encoder_Button_0 = LividRGB.BLUE
			Encoder_Button_1 = LividRGB.BLUE
			Encoder_Button_2 = LividRGB.BLUE
			Encoder_Button_3 = LividRGB.BLUE
			Encoder_Button_4 = LividRGB.BLUE
			Encoder_Button_5 = LividRGB.BLUE
			Encoder_Button_6 = LividRGB.BLUE
			Encoder_Button_7 = LividRGB.BLUE
			Encoder_Button_8 = LividRGB.BLUE
			Encoder_Button_9 = LividRGB.BLUE
			Encoder_Button_10 = LividRGB.BLUE
			Encoder_Button_11 = LividRGB.BLUE
